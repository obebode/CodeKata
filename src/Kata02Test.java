...
public class Kata02Test {
    ...
    public void testChop() throws Exception {
        ...
        assert_equal(3,  searcher.chop(7, [1, 3, 5, 7]))
        assert_equal(-1, searcher.chop(0, [1, 3, 5, 7]))
        assert_equal(-1, searcher.chop(2, [1, 3, 5, 7]))
        assert_equal(-1, searcher.chop(4, [1, 3, 5, 7]))
        assert_equal(-1, searcher.chop(6, [1, 3, 5, 7]))
        assert_equal(-1, searcher.chop(8, [1, 3, 5, 7]))
        */
